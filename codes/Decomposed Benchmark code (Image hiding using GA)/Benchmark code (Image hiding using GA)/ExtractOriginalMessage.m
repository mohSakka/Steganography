function [message]=ExtractOriginalMessage(oldChromPixelsInds,stego,chromPixelSeq,nvar,messageLength,chrom)
...
[messPixelSeq,chromPixelSeq]=CreateHostPixelSeq...
    (oldChromPixelsInds,xOff,yOff,direction,messReq,chromReq);
catch
    disp('ddd')
end
