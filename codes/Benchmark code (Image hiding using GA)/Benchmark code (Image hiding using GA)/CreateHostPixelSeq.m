function [messPixelSeq,chromPixelSeq]=CreateHostPixelSeq(xOff,yOff,direction,messReq,chromReq)
...
for i=0:chromReq-1
    chromPixelSeq(i+1)=sub2ind(size(imCover),numOfRows,numOfCols-i);
end
